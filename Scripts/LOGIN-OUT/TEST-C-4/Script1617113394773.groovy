...
//HACER LOGIN CON USUARIO  Y  CONTRASEÑA INVALIDOS---------TEST-C-4----------
...
WebUI.verifyElementPresent(findTestObject('LOGIN_OR/Page_Amazon Sign-In/div_There was a problem                                                                                  Your password is incorrect'), 
    0)
